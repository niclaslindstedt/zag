...
- Add non-interactive resume_with_prompt to AgentBuilder (#185)

### Fixed

- Honor on_log_event during resume_with_prompt (#186)

## [0.16.0] - 2026-04-28

### Added

- Extract process registration into shared helper (#184)
...
- Sync README, docs, and website with live event streaming feature (#162)

## [0.14.2] - 2026-04-18

### Added

- Add opt-in live event streaming to AgentBuilder (#161)

### Documentation

- Sync README, docs, manpages, and website with current source (#160)

## [0.14.1] - 2026-04-18

### Added

- Expose session metadata on PipeParams (#159)
...
- Add model and provider fields to AgentOutput (#143)

### Fixed

- Use structured_output fallback when Result.result is empty (#144)
