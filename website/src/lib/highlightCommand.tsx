/**
 * Tokenize a shell command string and return styled React nodes.
 * Recognizes double-quoted strings, flags, variable references, and plain text.
 */
